...
(function () {
    ...
    function initForms() {
        ...
        jQuery('#email-form').on('submit', function (e) {
            ...
            var serviceId = 'service_go50hx9'; // Your Service ID from EmailJS
            var templateId = 'template_1s1zo0k'; // Your Template ID from EmailJS
            var publicKey = 'P5Bmx8JhEflJK7pBv'; // Your Public Key from EmailJS Account
            ...
            if (!serviceId || !templateId || !publicKey || templateId === 'YOUR_TEMPLATE_ID' || publicKey === 'YOUR_PUBLIC_KEY') {
                ...
                // Fallback to mailto
                var mailtoLink = 'mailto:tradakevin0099@gmail.com?subject=Contact Form: ' + encodeURIComponent(name) + '&body=' + encodeURIComponent('Name: ' + name + '\nEmail: ' + email + '\n\nMessage:\n' + message);
